...
//==========P R O T O T Y P E N==================================================================
// Erstellt ein Partikelsystem mit Ursprung (x,y) und Partikel-Geschwindigkeit v
void CreateParticleSystem(float x, float y, float v);
...
void CreateParticleSystem(float x, float y, float v)
{
	...
	for (int i = 0; i < MAX_PARTICLES; i++)
	{
		...
		ParticleSystem.Particles[i].v[0] = v * cos(alpha_rad);
		ParticleSystem.Particles[i].v[1] = v * sin(alpha_rad);
	}
