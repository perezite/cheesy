...
{
  return __host_device_call(__cuda___signbitf(a));
}

__func__(float copysignf(float a, float b))
{
  return __host_device_call(__cuda_copysignf(a, b));
}
...
{
  return __host_device_call(__internal_nearbyintf(a));
}
...
__device_func__(float __cuda_expm1f(float a))
{
  ...
  z = __cuda_exp2f (j);
  a = z - 1.0f;
  if (a != 0.0f) u = __internal_fmad (u, z, a); /* pres. -0 generated by FTZ*/
...
{
  return __host_device_call(__fma_rn(a, b, c));
}
...
{
  return __host_device_call(__cuda___finitef(a));
}

__func__(int __isinff(float a))
{
  return __host_device_call(__cuda___isinff(a));
}

__func__(int __isnanf(float a))
{
  return __host_device_call(__cuda___isnanf(a));
}
...
{
  return (double)__host_device_call(__cuda_lgammaf((float)a));
}

__func__(double tgamma(double a))
{
  return (double)__host_device_call(__cuda_tgammaf((float)a));
}

__func__(double erf(double a))
{
  return (double)__host_device_call(__cuda_erff((float)a));
}

__func__(double erfinv(double a))
{
  return (double)__host_device_call(__cuda_erfinvf((float)a));
}

__func__(double erfc(double a))
{
  return (double)__host_device_call(__cuda_erfcf((float)a));
}

__func__(double erfcinv(double a))
{
  return (double)__host_device_call(__cuda_erfcinvf((float)a));
}

__func__(double remquo(double a, double b, int *quo))
{
  return (double)__host_device_call(__cuda_remquof((float)a, (float)b, quo));
}

__func__(double remainder(double a, double b))
{
  return (double)__host_device_call(__cuda_remainderf((float)a, (float)b));
}

__func__(double nextafter(double a, double b))
{
  return (double)__host_device_call(__cuda_nextafterf((float)a, (float)b));
}
