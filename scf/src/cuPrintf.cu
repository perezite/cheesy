...
__device__ static bool bPrintBlockAndThread;
...
//
//      set whether thread and block for a prinft should be printed as well
__device__ void togglePrintBlockAndThread(bool val)
{
	bPrintBlockAndThread = val;
}
...
extern "C" cudaError_t cudaPrintfInit(size_t bufferLen)
{
	...
	// set no printing of thread and block as standard
	bPrintBlockAndThread = false;
